...
export const AUTH_USER_NOT_LEGAL_AGE =
  ' The user is not of legal age (18 years old)';
...
export const AUTH_USER_PASSWORD_NOT_VALID =
  'Password min length is 6, max is 12';
export const AUTH_USER_BIRTH_DATE_NOT_VALID =
  'The user date birth is not valid';
export const AUTH_USER_NAME_NOT_VALID = 'Name min length is 3, max is 50';

export const REVIEW_TEXT_NOT_VALID =
